 ...
 * @returns {JSX.Element} edit screen
 */
export function EditPasswordScreen({setPasswordEntryName, passwordEntryName, setUsernameText, usernameText, setPasswordText, passwordText, selectedColour, setSelectedColour, handleGeneratePassword, onGenerateButtonPress, onAddButtonPress}) {
    return (
        <View style={Style.container}>
            <KeyboardAwareScrollView
                ...
                {/* Colour Picker */}
                <Picker style={Style.picker} selectedValue={selectedColour} onValueChange={(colour) => {setSelectedColour(colour)}}>
                    {
